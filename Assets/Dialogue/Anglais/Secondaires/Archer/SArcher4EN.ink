...
A Dungeon? So the @@house@@ led to a Dungeon? Is this the end of this puzzle? #chara:archer
Your @@house@@ would lead to my place? Haha! You're dreaming, archer. #chara:dragon
Then how? How can a door from the <color=blue>house</color> lead here? #chara:archer
I must understand!
* [Give him answers (loses @@@@@explorer@@@@@)] -> Regen
* [Calm him down (loses @@fearful@@)] -> Damages
    
=== Regen ===
You must have been the victim of a magical item... If your @@house@@ can lead to places you don't know, then perhaps it led you to this world? #chara:dragon 
...
Are you sure? You're right, if a door from the @@house@@ can lead here, then another one can surely take me back! #chara:archer #changepers:none
I have to be sure! 
-> END

=== Encounter2 ===
So, stranger, still looking for a way back to your @@house@@? #chara:dragon
...
* [Give him answers (loses @@@@@color=orange>explorer@@@@@)] -> Regen2
* [Motivate him (loses @@fearful@@)] -> Damages2
 -> END
 
 === Regen2 ===
Listen, Navidson... However you were transported here, there must be a way to get back home. #chara:dragon 
Your strange @@house@@ must be magical. There may be no way back if it was magic.
But then I'm stuck in this Dungeon? What will become of me... I must escape, survive, quickly! #chara:archer
-> END
