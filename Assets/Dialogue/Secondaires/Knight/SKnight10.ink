...
{SKnight10Seen : Vous savez sire Lume, vous aurez plus de chances de trouver une princesse en sortant de chez moi qu'en continuant de me réveiller à une heure pareille ! #chara:dragon }
...
~SKnight10Seen = true 
Ah ? Voilà qui est intriguant... Très bien, j'admet vous avoir sous-estimé... #chara:dragon
...
Allons, ne ment pas Dragon, tout le monde sait bien que les créatures dans ton genre apprécient ce genre de choses... #chara:knight
Je n'apprécie que les pièces d'or et la grasse-matinée chevalier... Alors trève de bavardage, battons-nous. #chara:dragon
    -> END
