...
{
    public static DirectionToMove FindPath(Vector2Int start, Vector2Int end, TileData[,] map, Personnalities AENLEVER)
    {
        List<List<TileData>> paths = BFS(start, end, map);
        
        //TODO : switch OBJECTIVES pour les différents comportements
