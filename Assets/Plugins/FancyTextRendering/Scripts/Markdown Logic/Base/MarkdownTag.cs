...
namespace LogicUI.FancyTextRendering.MarkdownLogic
{
    internal abstract class SimpleMarkdownTag : MarkdownTag
    {
        ...
        public override string GetMarkdownOpenTag(MarkdownRenderingSettings _) => MarkdownIndicator;
        public override string GetMarkdownCloseTag(MarkdownRenderingSettings _) => MarkdownIndicator;
    ...
    {
        public abstract string GetMarkdownOpenTag(MarkdownRenderingSettings settings);
        public abstract string GetMarkdownCloseTag(MarkdownRenderingSettings settings);
